...
<tr><td colspan="2">
				<input type="text"  name="keyword" id="keyword" value="<?=$_POST["wordkey"];?>" /></td> <td align="center"><a href="javascript:if (document.forms[0].keyword.value != '') document.forms[0].submit(); else {document.forms[0].keyword.value = ' '; document.forms[0].submit();}"><img  src="images/buscarbtn.gif" border="0" ></a>
