<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /promotion/allcategoriescontent.php
	# ----------------------------------------------------------------------------------------------------
			...
			if ($categories) {
				for ($i=0; $i<count($categories); $i++) {
					...
					if (MODREWRITE_FEATURE == "on") {
						$code_include .= "<a href=\"".PROMOTION_DEFAULT_URL."/guide/".$categories[$i]["friendly_url".$langIndex]."\">";
					} else {
						$code_include .= "<a href=\"".PROMOTION_DEFAULT_URL."/results.php?category_id=".$categories[$i]["id"]."\">";
					}
