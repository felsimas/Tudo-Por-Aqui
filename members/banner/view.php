		...
		<?php 	include(MEMBERS_EDIRECTORY_ROOT."/menu.php"); ?>
			<div id="main-content"> 
				...
				<div id="header-form"><?=system_showText(LANG_MANAGE_BANNER);?> - <?=$banner->getString("caption")?></span></div>
					...
					<a class="btn2 ui-state-default ui-corner-all" href="<?=DEFAULT_URL?>/membros/banner/edit.php?id=<?=$bannerObj->getNumber("id")?>&screen=<?=$screen?>&letra=<?=$letra?>">
					...
					<a class="btn2 ui-state-default ui-corner-all" href="<?=DEFAULT_URL?>/membros/banner/delete.php?id=<?=$bannerObj->getNumber("id")?>" class="link-view">
