	...
	<div id="page-wrapper">
		...
		<?php 	include(MEMBERS_EDIRECTORY_ROOT."/menu.php"); ?>
			...
			<div id="main-content"> 
				...
				<div id="header-form"><?=system_showText(LANG_GALLERY_IMAGE_DELETE)?> - <span><?=$gallery->getString("title")?></span></div>

				<h2 class="standardSubTitle"><?=system_showText(LANG_IMAGE_DELETE)?></h2>

				<div class="response-msg success ui-corner-all"><?=system_showText(LANG_IMAGE_SUCCESSFULLY_DELETED)?></div>

				<form name="back" action="<?=DEFAULT_URL?>/membros/gallery/images.php" method="post">
