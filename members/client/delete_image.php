	...
	<div id="page-wrapper">
		...
		<?php 	include(MEMBERS_EDIRECTORY_ROOT."/menu.php"); ?>
			...
			<div id="main-content"> 
				...
				<div id="header-form"><?=system_showText(LANG_GALLERY_IMAGE_DELETE)?> - <span><?=$client->getString("title")?></span></div>
				...
				<form name="back" action="<?=DEFAULT_URL?>/membros/client/images.php" method="post">
