					...
					<div class="portlet-content">
						<div id="accordion">
							...
							<div>
								...
								<div>
									<ul class="side-menu">
										<li><a href="<?=DEFAULT_URL?>/membros/listing/listinglevel.php" title="Adicionar Estabelecimento">Adicionar Estabelecimento</a></li>
										<li><a href="<?=DEFAULT_URL?>/membros/listing/" title="Gerenciar Empresas">Gerenciar Estabelecimento</a></li>
									</ul>
								</div>
							</div>
							...
							<div>
						 	...
						 	<div>
								<h3><a href="#">Hist&oacute;rico</a></h3>
								<div>
									<ul class="side-menu">
										<li><a href="<?=DEFAULT_URL?>/membros/transactions/index.php" title="Hist&oacute;rico de Transa&ccedil;&otilde;es">Hist&oacute;rico de Transa&ccedil;&otilde;es</a></li>
