		...
		function Delete() {
			...
			if ($this->id != 0) {
				...
				while ($row = mysql_fetch_array($r)) {
					$sql = "UPDATE Article SET cat_1_id = 0, parcat_1_level1_id = 0 WHERE cat_1_id = $row[id]";
					$dbObj->query($sql);
					$sql = "UPDATE Article SET cat_2_id = 0, parcat_2_level1_id = 0 WHERE cat_2_id = $row[id]";
					$dbObj->query($sql);
					$sql = "UPDATE Article SET cat_3_id = 0, parcat_3_level1_id = 0 WHERE cat_3_id = $row[id]";
					$dbObj->query($sql);
					$sql = "UPDATE Article SET cat_4_id = 0, parcat_4_level1_id = 0 WHERE cat_4_id = $row[id]";
					$dbObj->query($sql);
					$sql = "UPDATE Article SET cat_5_id = 0, parcat_5_level1_id = 0 WHERE cat_5_id = $row[id]";
					$dbObj->query($sql);
				}
				...
				$sql = "DELETE FROM ArticleCategory WHERE category_id = $this->id";
				$dbObj->query($sql);

				$sql = "UPDATE Article SET cat_1_id = 0, parcat_1_level1_id = 0 WHERE cat_1_id = $this->id";
				$dbObj->query($sql);
				$sql = "UPDATE Article SET cat_2_id = 0, parcat_2_level1_id = 0 WHERE cat_2_id = $this->id";
				$dbObj->query($sql);
				$sql = "UPDATE Article SET cat_3_id = 0, parcat_3_level1_id = 0 WHERE cat_3_id = $this->id";
				$dbObj->query($sql);
				$sql = "UPDATE Article SET cat_4_id = 0, parcat_4_level1_id = 0 WHERE cat_4_id = $this->id";
				$dbObj->query($sql);
				$sql = "UPDATE Article SET cat_5_id = 0, parcat_5_level1_id = 0 WHERE cat_5_id = $this->id";
				$dbObj->query($sql);
