		...
		if ($rate_avg) {
			...
			$item_review .= "<ul class=\"rating\">";
				...
				//}
					...
					//if (!$bt_rate_off){
					//	if ($review_amount > 0) {
					//		$item_review .= "<li class=\"rateIt\"><a href=\"javascript:void(0)\" onclick=\"".$linkReviewFormPopup."\" >" . system_showText(LANG_REVIEWRATEIT) . "</a></li>";
					//	} else {
					//		 $item_review .= "<li class=\"rateIt\"><a href=\"javascript:void(0)\" onclick=\"".$linkReviewFormPopup."\" >" . system_showText(LANG_REVIEWBETHEFIRST) . "</a></li>";
					//	}
					//}
