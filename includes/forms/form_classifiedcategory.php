	...
	<tr>
		<td colspan="2">
			<span class="label-login">
				<p style="text-align: justify;"><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL1)?><br /><br /><strong><?=system_showText(LANG_SITEMGR_FOREXAMPLE)?>:</strong><br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL2)?><br />"<?=CLASSIFIED_DEFAULT_URL?>/guide/computer"<br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL3)?><br />"<?=CLASSIFIED_DEFAULT_URL?>/guide/computer/software-development"<br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL4)?></p>
			</span>
		</td>
	</tr>
	<tr class="tr-form">
