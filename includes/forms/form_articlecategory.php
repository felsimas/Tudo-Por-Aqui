		...
		<td colspan="2">
			<table border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<td class="font-view" style="font-size:11px" align="left">
					&nbsp;<?=LANG_SITEMGR_KEYWORD_SAMPLE_1?><br />
					&nbsp;<?=LANG_SITEMGR_KEYWORD_SAMPLE_2?><br />
					&nbsp;<?=LANG_SITEMGR_KEYWORD_SAMPLE_3?><br />
				</td>
				</tr>
			</table>
		</td>
...
<div id="header-form"><?=ucwords(system_showText(LANG_SITEMGR_CONTENT_SEOCENTER))?></div>

<table cellpadding="2" cellspacing="0" class="table-form" border="0">
	<tr>
		<td colspan="2">
			<span class="label-login">
				<p style="text-align: justify;"><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL1)?><br /><br /><strong><?=system_showText(LANG_SITEMGR_FOREXAMPLE)?>:</strong><br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL2)?><br />"<?=ARTICLE_DEFAULT_URL?>/guide/computer"<br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL3)?><br />"<?=ARTICLE_DEFAULT_URL?>/guide/computer/software-development"<br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL4)?></p>
			</span>
		</td>
	</tr>
	<tr class="tr-form">
		...
		<td align="left" class="td-form">
			<input type="text" id="friendly_url" name="friendly_url" class="input-form-article" value="<?=$friendly_url?>" OnBlur="easyFriendlyUrl(this.value, 'friendly_url', '<?=FRIENDLYURL_VALIDCHARS?>\n', '<?=FRIENDLYURL_SEPARATOR?>');" />
		</td>
	</tr>
	<tr class="tr-form">
		<td align="right" class="td-form">
