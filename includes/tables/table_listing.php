	...
	if ($listings) foreach ($listings as $listing) {
		...
		<tr>
			<td>
				...
				?>
				<a href="<?=$url_redirect?>/visualizar/<?=$id?>" class="link-table"><?=$listing->getString("title");?></a>
			</td>
		<!-- 	<td>
				<?
				$level = new ListingLevel(EDIR_DEFAULT_LANGUAGE, true);
			...
			<td nowrap="nowrap">
				...
				<a class="tooltip" title="<?=system_showText(LANG_MSG_CLICK_TO_VIEW_THIS_LISTING)?>" href="<?=$url_redirect?>/visualizar/<?=$id?>" class="link-table">
					<img src="<?=DEFAULT_URL?>/images/bt_view.gif" border="0" alt="<?=system_showText(LANG_MSG_CLICK_TO_VIEW_THIS_LISTING)?>" />
				</a>

				<a class="tooltip" title="<?=system_showText(LANG_MSG_CLICK_TO_EDIT_THIS_LISTING)?>" href="<?=$url_redirect?>/editar/<?=$id?>" class="link-table">
				...
				<? if ((LISTING_MAX_GALLERY > 0) && (($listingImages > 0) || ($listingImages == -1))) { ?>
					<a class="tooltip" title="<?=system_showText(LANG_MSG_CLICK_TO_VIEW_THIS_LISTING)?>" href="<?=$url_redirect?>/fotos/<?=$id?>" class="link-table">
				...
				<? } ?>
				<a class="tooltip" title="<?=system_showText(LANG_MSG_CLICK_TO_VIEW_THIS_LISTING)?>" href="<?=$url_redirect?>/promocao/<?=$id?>" class="link-table">
		...
		<!--		<? if ($listingHasPromotion == "y") { ?>
				...
				<a class="tooltip" title="<?=system_showText("Click aqui para ver os clientes desta empresa")?>" href="<?=$url_redirect?>/clientes/<?=$id?>" class="link-table">
					<img src="<?=DEFAULT_URL?>/images/icon_client.gif" border="0" alt="<?=system_showText("Click aqui para ver os clientes dessa empresa")?>" />
				</a>

				<a class="tooltip" title="<?=system_showText(LANG_MSG_CLICK_TO_VIEW_THIS_LISTING_REPORTS)?>" href="<?=$url_redirect?>/relatorio/<?=$id?>" class="link-table">
				...
				<? if (strpos($url_base, "/gerenciamento")) { ?>
					<a class="tooltip" href="<?=$url_redirect?>/apagar/<?=$id?>"  title="<?=system_showText(LANG_MSG_CLICK_TO_DELETE_THIS_LISTING)?>">
