<div id="sidebar">
								...
								<div>
									<ul class="side-menu">
										<li><a href="<?=DEFAULT_URL?>/gerenciamento/conta">Minha Conta</a></li>
											...
											<li><a href="<?=DEFAULT_URL?>/gerenciamento/administradores"><?=system_showText(LANG_SITEMGR_NAVBAR_SITEMGRACCOUNTS)?></a></li>
									</ul>
								</div>		
							</div>
			<? } ?>
			...
			<? if (!$_SESSION[SESS_SM_ID]) { ?>
					...
					<h3><a href="<?=DEFAULT_URL?>/gerenciamento/relatorios"><?=system_showText(LANG_SITEMGR_NAVBAR_REPORTS)?></a></h3>
							<div>
								<ul class="side-menu">
									<li><a href="<?=DEFAULT_URL?>/gerenciamento/relatorios"><?=system_showText(LANG_SITEMGR_NAVBAR_STATISTICREPORT)?></a></li>
								</ul>
							</div>
					</div>	
			<? } ?>
