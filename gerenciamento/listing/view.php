			...
			<div id="header-view">
				...
				<div style="float:left; width:313px">
					<strong><?=system_showText(LANG_SITEMGR_LASTUPDATED)?>:</strong> <span class="label-field-account"><?=format_date($listing->getNumber("updated"),DEFAULT_DATE_FORMAT." - H:i:s", "datetime")?></span>
									<a href="<?=DEFAULT_URL?>/gerenciamento/estabelecimentos/editar/<?=$listing->getNumber("id")?>" class="btn2 ui-state-default ui-corner-all">
									...
									<a href="<?=DEFAULT_URL?>/gerenciamento/estabelecimentos/tipo/<?=$listing->getNumber("id")?>" class="btn2 ui-state-default ui-corner-all">
