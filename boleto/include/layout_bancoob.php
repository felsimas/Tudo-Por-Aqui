...
<br>
<center>
		<p name="print" id="print"><a href="javascript:void(0);" onclick="document.getElementById('print').style.display='none';window.print();document.getElementById('print').style.display='block'" style="color:#000000; font: bold 10pt Verdana, Arial, Helvetica, sans-serif;"><?=system_showText("Clique aqui para imprimir o boleto");?></a></p>
